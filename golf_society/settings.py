"""
Django settings for golf_society project.
...
TEMPLATE_DIR = os.path.join(BASE_DIR,'golf_app/templates/golf_app')
...
ALLOWED_HOSTS = ['https://golf-society.herokuapp.com/', 'golf_society']
...
WSGI_APPLICATION = 'golf_society.wsgi.application'
